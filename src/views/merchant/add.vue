    ...
    <div class="head-container">
      ...
      <el-main>
       ...
       <!--      <el-col :xs="{span:6,offset:12}" :sm="{span:6,offset:12}" :md=6 :lg=6>
            ...
            <el-col :xs=6 :sm=10 :md="{span:6,offset:1}" :lg=6>
            ...
            <el-col :xs=24 :sm=8 :md="{span:6,offset:1}" :lg=6>
          ...
          <el-row :gutter="20">
            <el-col :xs=24 :sm=6 :md=6 :lg=6>
              <el-form-item label="管理库存">
                <el-input type="number" :min="1" v-model="form.manageInventory"></el-input>
              </el-form-item>
            </el-col>
            ...
            <el-col :xs="{span:6,offset:0}" :sm="{span:6,offset:3}" :md="{span:6,offset:1}" :lg="{span:6,offset:0}">
