  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-select v-model="query.status" clearable placeholder="支付状态" class="filter-item" style="width: 130px">
 ...
 <!--表格渲染-->
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column v-permission="['admin','posOrder:edit','posOrder:del']" label="操作" width="150px"
          ...
          <template slot-scope="scope">
            <el-link type="primary" :underline="false" v-permission="permission.add" @click="toShowInfo(scope.$index)">
              详情
            </el-link>
          </template>
        </el-table-column>
